...
export const LogoLoop = memo(
  ({
    ...
    const cssVariables = useMemo(
      () => ({
        "--logoloop-gap": `${gap}px`,
        "--logoloop-logoHeight": `${effectiveLogoHeight}px`,
        ...(fadeOutColor && { "--logoloop-fadeColor": fadeOutColor }),
      }),
      [gap, effectiveLogoHeight, fadeOutColor]
    );
    ...
    const renderLogoItem = useCallback(
      (item, key) => {
        ...
        return (
          <li
            className={cx(
              "flex-none mr-12 md:mr-[var(--logoloop-gap)] text-[length:var(--logoloop-logoHeight)] leading-[1]",
